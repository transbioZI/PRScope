...
system(paste0(plink2, " --bfile ", paste0(input,".temp2"), " --make-bed --allow-no-sex --rm-dup exclude-all list --out ", paste0(input,".temp3")))
system(paste0(plink, " --bfile ", paste0(input,".temp3"), " --pca --allow-no-sex --make-bed --threads 20 --missing --freq --het --out ",output))

target_data = as_tibble(read.table(paste0(input,".temp3.bim")))
...
system(paste0(plink, " --bfile ", paste0(input,".temp3"), " --make-bed --allow-no-sex --threads 20 --out ", paste0(input,".temp4")," --extract ",paste0(input,".extract2")," --keep ", paste0(input,".keep_samples")))

system(paste0(plink, " --bfile ", paste0(input,".temp4")," --hwe 0.001 --geno 0.02 --make-founders  --make-bed --threads 20 --out ", paste0(input,".filtered2")))
system(paste0(plink, " --bfile ", paste0(input,".filtered2"), " --indep-pairwise 200 100 0.2 --maf 0.05 --threads 20 --out ", paste0(input,".filtered3")))
system(paste0(plink, " --bfile ", paste0(input,".filtered2"), " --make-bed --extract ",paste0(input,".filtered3.prune.in"), " --threads 20 --out ", paste0(input,".filtered4")))
system(paste0(plink, " --bfile ", paste0(input,".filtered4"), " --indep-pairwise 200 100 0.2 --threads 20 --out ", paste0(input,".filtered5")))
...
system(paste0(plink, " --bfile ", output, " --extract ",paste0(input,".filtered5.prune.in"), " --pca --autosome --threads 20 --out ", paste0(output,".POP_STRATIFICATION")))

after_qc = read.table(paste0(output,".eigenvec"))
colnames(after_qc) = c("FID","IID",paste0("PC",c(1:20)))
...
pairs(after_qc[,3:8])
dev.off()
pdf(paste0(output,".POP_STRATIFICATION.pdf"))
