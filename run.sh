...
snakemake -s $REPOSITORY_PATH/main/snakefiles/qc_sumstats.snakefile --configfile $REPOSITORY_PATH/config/config_vanilla.yaml --jobs $NUMBER_OF_THREADS --config repository=$REPOSITORY_PATH/main --use-conda --conda-frontend conda -k --rerun-triggers mtime
snakemake -s $REPOSITORY_PATH/main/snakefiles/calc_heritability.snakefile --configfile $REPOSITORY_PATH/config/config_vanilla.yaml --jobs $NUMBER_OF_THREADS --config repository=$REPOSITORY_PATH/main --use-conda --conda-frontend conda -k --rerun-triggers mtime
snakemake -s $REPOSITORY_PATH/main/snakefiles/calc_genetic_correlation.snakefile --configfile $REPOSITORY_PATH/config/config_vanilla.yaml --jobs $NUMBER_OF_THREADS --config repository=$REPOSITORY_PATH/main --use-conda --conda-frontend conda -k --rerun-triggers mtime
snakemake -s $REPOSITORY_PATH/main/snakefiles/calc_heritability.snakefile --configfile $REPOSITORY_PATH/config/config_vanilla.yaml --config repository=$REPOSITORY_PATH/main --use-conda --conda-frontend conda -k --rerun-triggers mtime
snakemake -s $REPOSITORY_PATH/main/snakefiles/calc_genetic_correlation.snakefile --configfile $REPOSITORY_PATH/config/config_vanilla.yaml --config repository=$REPOSITORY_PATH/main --use-conda --conda-frontend conda -k --rerun-triggers mtime
