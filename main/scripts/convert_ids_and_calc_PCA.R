...
if(convert == TRUE) {
system(paste0(plink2, " --bfile ", paste0(input,".temp1"), " --max-alleles 2 --snps-only just-acgt --make-bed --allow-no-sex --set-all-var-ids @:# --out ", paste0(input,".temp2")))
} else {
